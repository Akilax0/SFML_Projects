...
int main(){
    ...
    RenderWindow appWindow1(VideoMode(800,800),"Langdon's Ant Main");
    Event appEvent1;
    ...
    while(appWindow1.isOpen()){
        while (appWindow1.pollEvent(appEvent1))
        {
            ...
            {
                std::cout<<sf::Mouse::getPosition(appWindow1).x/size<<" "<<sf::Mouse::getPosition(appWindow1).y/size<<std::endl;  

                temp[sf::Mouse::getPosition(appWindow1).y/size][sf::Mouse::getPosition(appWindow1).x/size] = temp[sf::Mouse::getPosition(appWindow1).y/size][sf::Mouse::getPosition(appWindow1).x/size]^1;
            }
            
            if((appEvent1.type == sf::Event::KeyPressed) && (sf::Keyboard::isKeyPressed(sf::Keyboard::Enter)))
            {
